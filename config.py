...
class Config(object):
    ...
    AUTH_USERS = set(int(x) for x in os.environ.get("AUTH_USERS", "275484069 322116131").split())
    ...
    DEF_THUMB_NAIL_VID_S = os.environ.get("DEF_THUMB_NAIL_VID_S", "https://mydrive.curatedstuffs.workers.dev/0:/SeedBox/2021-01-29_10:33:30.jpg")
